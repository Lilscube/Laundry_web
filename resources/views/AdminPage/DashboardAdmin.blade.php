...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="{{ url('AdminPage/tentangKami2') }}" class="brand-link">
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info text-center">
                        <a href="{{ url('AdminPage/indexProfileAdmin') }}" class="nav-link" style="color:white">
                            Admin
                        </a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <a href="{{ url('AdminPage/indexAdmin') }}" class="nav-link">
                                <i class="nav-icon fas fa-home"></i>
                                <p>Dashboard</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('AdminPage/karyawan') }}" class="nav-link">
                                <i class="nav-icon fas fa-users"></i>
                                <p>Karyawan</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('AdminPage/indexTotal') }}" class="nav-link">
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; {{ date('Y') }} <a href="{{ url('AdminPage/tentangKami2') }}" style="color: #0066cc;">Laundry Licius</a>.</strong> All rights reserved.
        </footer>
    </div>
