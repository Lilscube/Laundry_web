                ...
                <div class="card-body p-5">
                    <form id="serviceForm" action="{{ url('api/layanan/store') }}" method="POST">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="number" id="berat" name="berat" class="form-control" required placeholder="Masukkan berat cucian" min="1">
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="number" id="harga" name="harga" class="form-control" readonly placeholder="Harga layanan">
                        </div>
                        ...
                        <button type="submit" class="btn btn-block text-white" style="background: linear-gradient(135deg, #005082, #00a5cf); font-size: 1.1rem; padding: 10px 0; border-radius: 5px;">
                            Kirim Permintaan
                        </button>
                    </form>
                </div>
...
document.getElementById('berat').addEventListener('input', function() {
    const berat = parseFloat(this.value) || 0; // Ambil nilai berat atau 0 jika kosong
    const hargaPerKg = 10000; // Harga per kg
    const totalHarga = berat * hargaPerKg; // Kalkulasi total harga

    document.getElementById('harga').value = totalHarga; // Set nilai input harga
});
...
document.getElementById('serviceForm').addEventListener('submit', function(event) {
    ...
    const formData = {
        detail_layanan: document.getElementById('detail_layanan').value,
